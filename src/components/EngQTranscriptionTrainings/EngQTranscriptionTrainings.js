...
import styles from './EngQTranscriptionTrainings.module.css';

export default function EngQTranscriptionTrainings({ tasksArr }) {
  ...
  useEffect(() => {
    setOriginalArray([...tasksArr[taskId].qtrn]);
  }, [taskId, tasksArr]);
...
EngQTranscriptionTrainings.propTypes = {
